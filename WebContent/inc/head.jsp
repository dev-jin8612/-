...
<header>
	<div class="header">
		<div class="inner-header">
			...
			<h1 class="logo">
				<span class="sound-only">와디즈</span> <a href="/"><img src="${pageContext.request.contextPath}/upload/logo.png"></a>
			</h1>
			<!-- //logo -->
				...
				<div class="head-user">
					...
					<div class="gest" id="login">
						<a href="${pageContext.request.contextPath}/logout.member"
							class="login">로그아웃</a> <a href="${pageContext.request.contextPath}/myProfile.mypage" class="login">마이 페이지</a>
					</div>
					<button type="button" class="full_btn" onclick="create()">프로젝트 만들기</button>
				</div>
			</div>
		</div>
	</div>
