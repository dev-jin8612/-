	...
	<header>
		...
		<div class="header">
			<div class="inner-header">
				...
				<h1 class="logo">
					<span class="sound-only"></span> <a href="/"> <svg
	...
	<div id="WadizContainer">
		<div class="MypageWrap">
			<div class="myprofile-wrap">
				<link rel="stylesheet"
					href="https://static.wadiz.kr/static/iam/main.cb8b16fe.css" />
						...
						<div class="SupporterProfile-inner">
							...
							<div aria-hidden="true" class="Avatar-avatar">
								<span class="Avatar-hasImage"
									style="background-image: url(&quot;https://static.wadiz.kr/assets/icon/profile-icon-2.png&quot;);">
								</span>
							</div>
							...
							<div class="SupporterProfileInfo-supporterInfo">
								...
								<dl class="SupporterProfileActivityInfo-infoCountBox">
									<div class="SupporterProfileList">
										<dt>스크랩</dt>
										<dd>
											0 <span class="BlindText_t                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         extHidden1">개</span>
										</dd>
									</div>
									<div>
										<dt>게시물</dt>
									...
									<div class="follower-following">
										<dt>팔로잉</dt>
										<dd>
											0 <span class="BlindText_textHidden">명</span> 
											<a ref="/web/social/followingsupporter">
							...
							<a href="/web/wmypage/myprofile/modifyprofile"
								class="Button-button-Button-block"> <span> <span
									class="Button-children">프로필 편집</span></span>
							</a> <a href="/web/wmypage/myprofile/modifyprofile"
								class="Button-button-Button-block"> <span> <span
									class="Button-children">피드 글쓰기</span></span>
							</a>
						</div>
					</section>
				</div>
	...
	<div class="mypage-project">
		<div class="tab-list">
			<ul role="tablist" class="tablist-ul">
				<li class="tablist-list"><a href="#" onclick="loadData('feed')">내
						피드</a></li>
				<li class="tablist-list"><a href="#"
					onclick="loadData('trade')">나의 교환내역</a></li>
				<li class="tablist-list"><a href="#"
					onclick="loadData('withUs')">우리 함께해요</a></li>
				<li class="tablist-list"><a href="#"
					onclick="loadData('scrap')">스크랩</a></li>
			</ul>
		</div>
		<div class="project-list" id="tabFunding" tabindex="0">
			<div class="top-area">
				<p id="fundingInfoMessage" class="status-text fundingCount"
					style="display: none">공개로 참여한 프로젝트입니다.</p>
			</div>
			<div class="card-list" id="projectCardList">
				...
				<ul>
					...
					<li class="list-list" data-hiddentype="L" data-campaintype="RWD"
						data-campaignid="181138" data-campaignhiddenseq="0">
						<a href="">
							<div class="project-card">
									 ...
									 <em class="heart-wrapper">
										<div class="heart">
											<svg viewBox="0 0 32 32" focusable="false"
												role="presentation" class="withIcon-icon" aria-hidden="true"
												style="width: 24px; height: 24px;">
                								<path
								...
								<div class="card-info-section">
									...
									<div class="card-category">
										<span class="categoroy1">작성 날짜</span>
									</div>
								</div>
							</div>
						</a>
					...
					<section class="FContainer_leftSection">
						...
						<div class="FContainer_buttonBlock">
							...
							<a href="/" class="FContainer_directBtn" target="_blank"
								rel="noreferrer">문의 등록하기 <!-- 등록하기 옆 화살표 이미지 --> <img src=""
								alt="" /></a><a href="/"
