				...
				<div id="tabContent1" class="tab-content">
					...
					<div class="profileimg-wrap">
						<button type="button" id="resultProfileImg" class="profileimg"
							onclick="$('#uploadProfileImg').click();">
							<em
								style="background-image: url(https://static.wadiz.kr/assets/icon/profile-icon-2.png)"></em>
						</button>
						<p class="setting-profileimg">
							...
							<button type="button" onclick="deletePhoto()"
								id="btn-deletePhoto">삭제</button>
						</p>
					</div>
					<h5>이름</h5>
					<input type="text" class="input-text" maxlength="50" id="position"
						placeholder="이름" value="">
					<h5>나이</h5>
					<input type="text" class="input-text" maxlength="50" id="position"
						placeholder="나이" value="">
					<h5>성별</h5>
					<select name="job" class="select-text">
					...
					<input id="mobileNumber" name="mobileNumber" type="tel"
						class=" input-text" placeholder="휴대폰 번호" value="">
					<div id="mobileCheckBtn" class="mobileAuthBtn btn"
						data-status="check">
						<a href="#" onclick="return false;"> <span class="inzeung">인증하기</span>
						</a>
					</div>
					...
					<div class="btn-buttom">
						<ul class="btn-div2">
							<li>
								<button type="button" class="wz button gray btn-darkgray"
									onclick="cancelModify()">취소</button>
							</li>
							<li>
								<button type="button" class="wz button primary btn-mint"
									onclick="cancelModify()">확인</button>
							</li>
						</ul>
					</div>
					<!--  -->
