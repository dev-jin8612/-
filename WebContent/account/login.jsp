    ...
    <div class="inner-container">
      ...
      <form action="">
        <div class="input-area">
          ...
          <div class="input-con">
            <input type="password" id="userPassword" name="userPassword" class="input_txt"placeholder="비밀번호 입력">
            <p class="message_wrap">와디즈에 등록되지 않은 아이디거나, 아이디 또는 비밀번호가 회원정보와 일치하지 않습니다.</p>
          </div>
        </div>
      </form>
      <p class="forgot"><a href="#">로그인 정보를 잊으셨나요?</a></p>
