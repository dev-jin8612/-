    ...
    <div class="inner-container">
        ...
        <div class="input-area">
          ...
          <div class="input-con">
            ...
            <div class="password-wrap">
              <input type="password" id="userPassword1" name="userPassword1" class="input_txt type2" placeholder="비밀번호 입력">
              <button type="button" class="pw-view"><i class="xi-eye"></i></button>
              
            </div>
            <div class="password-wrap">
              <input type="password" id="userPassword2" name="userPassword2" class="input_txt type2" placeholder="비밀번호 확인">
              <button type="button" class="pw-view"><i class="xi-eye"></i></button>
            </div>
          </div>
        </div>
      ...
      <div class="all-agree-area">
        <div class="checkbox-wrap">
          <input type="checkbox" name="allAgree" id="allAgree" class="input_checkbox">
        </div>
        <label for="allAgree" class="all-agree-label">
          <p>전체동의
            <button type="button" class="agree-toggle-btn"  onclick="fn_layerOpen('#joinAgreeLayer')">
              <svg viewBox="0 0 32 32" focusable="false" role="presentation" class="withIcon_icon__2KxnX" aria-hidden="true"><path d="M16 22.4L5.6 12l1.12-1.12L16 20.16l9.28-9.28L26.4 12 16 22.4z"></path></svg>
            </button>
          </p>
...
<div class="layer-popup" id="joinAgreeLayer">
  ...
  <div class="inner-layer">
    <div class="layer-head">
      <button type="button" class="close-btn" onclick="fn_layerClose('#joinAgreeLayer')">
        <svg viewBox="0 0 40 40" focusable="false" role="presentation"
          class="withIcon_icon__3VTbq ConfirmModal_closeIcon__23VbM" aria-hidden="true">
    ...
    <div class="layer-body">
      <div class="inner">
        ...
        <form action="">
          <!-- 전체동의 -->
          <div class="all-check">
            <input type="checkbox" name="allAgree" id="allAgree2" class="input_checkbox">
            <label for="allAgree2">전체동의 <span>(선택항목 포함)</span></label>
          </div>
          <!-- //전체동의 -->
          <!-- 서비스 area -->
            ...
            <div class="agree-list-wrap">
              <div class="agree-list">
                <div class="main check-area">
                  <div>
                    <input type="checkbox" name="userJoin" id="userJoin" class="input_checkbox">
                    <label for="userJoin"><strong>회원·서비스 </strong>가입<span class="txt-point">(필수)</span></label>
                  </div>
                  <button type="button" class="mainMoreBtn"><i class="xi-angle-down"></i></button>
                </div>
                <div class="inner-agree-wrap">
                  <div class="inner-agree">
                    <div class="check-area">
                      <div>
                        <input type="checkbox" name="userJoin01" id="userJoin01" class="input_checkbox">
                        <label for="userJoin01">회원가입 약관</label>
                      </div>
                  ...
                  <div class="inner-agree">
                    <div class="check-area">
                      <div>
                        <input type="checkbox" name="userJoin02" id="userJoin02" class="input_checkbox">
                        <label for="userJoin02">개인정보 수집 및 이용 동의</label>
                      </div>
                      <button type="button" class="moreBtn">내용보기</button>
                    </div>
                    <div class="agree-con">
                ...
                <div class="main check-area">
                  <div>
                    <input type="checkbox" name="userJoin3" id="userJoin3" class="input_checkbox">
                    <label for="userJoin3">회원·서비스 이벤트 혜택 알림(선택)</label>
                    <p>펀딩·프리오더·스토어 서비스, 이벤트·할인 혜택 등에 대한 정보를 이메일, 앱 알림(앱 회원가입 시)로 받아볼 수 있습니다. (동의 철회 시까지)</p>
                  </div>
                </div>
                <!-- 회원서비스 이벤트 혜택 알림 -->
                <!-- 만 14세 이상 -->
                <div class="main check-area">
                  <div>
                    <input type="checkbox" name="userJoin4" id="userJoin4" class="input_checkbox">
                    <label for="userJoin4">만 14세 이상입니다.<span class="txt-point">(필수)</span></label>
                  </div>
                </div>
                <!-- 만 14세 이상 -->
              </div>
