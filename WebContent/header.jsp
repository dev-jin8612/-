			...
			<div class="web-header-large">
				<header class="header-wrapper web-header-simple">
					<div class="header-container">
						<h1 class="wadiz-logo">
							<a href="/"><span class="label">와디즈</span>
						...
						<ul class="gnb-large">
							<li class="login"><a href="/web/waccount/wAccountLogin"
								class="item"><span>로그인</span></a></li>
							<li class="signup"><a
								href="/web/waccount/wAccountRegistIntro" class="item"><span>회원가입</span></a></li>
						</ul>
						<div class="PreviewOverlay_container__3Q3h2">
							<svg viewBox="0 0 40 40" focusable="false" role="presentation"
								class="withIcon_icon__djI-9" aria-hidden="true"
							...
							<p class="PreviewOverlay_description__2ihG6">저장한 내용을 미리 볼 수
								있어요.</p>
						</div>
					</div>
				</header>
